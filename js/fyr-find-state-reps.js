   var fyr_latlong = new google.maps.LatLng();
    ...
    function fyr_ajax_successfn(fyr_results, status, xhr) {
         ...
         jQuery.each(fyr_results, function (index, value) {
             ...
             fyr_photoElement.innerHTML = '<b><br><img class="fyr-rep-photo" src="' + this.photo_url + '" alt="' + this.full_name + '">';
             fyr_nameElement.innerHTML = '<h5 class="fyr-rep-name">' + this.full_name + '</h5>';
